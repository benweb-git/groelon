...
import {get_all_transactions, messageClear } from '../../store/reducers/participantReducer';
                ...
                <div className='flex flex-col gap-y-4'>
                    ...
                    <div className="relative overflow-x-auto hidden md:block">
                        ...
                        {uniqueUsers.length > 0 ? (
                            ...
                            <div className="text-center py-8">No transactions to display. Click "Get All transactions" to load data.</div>
                        )}
                    </div>
